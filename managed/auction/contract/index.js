...
// SDK v5.0.0-beta.8 compatibility: type-check guards below accept both old flat format
// { currentQueryContext } and new wrapped format { callContext: { currentQueryContext } }
...
class _tuple_0 {
  ...
  toValue(value_0) {
    return _descriptor_2.toValue(value_0[0]).concat(_descriptor_0.toValue(value_0[1]).concat(_descriptor_2.toValue(value_0[2])));
  }
}
...
export class Contract {
    ...
    this.circuits = {
      commitBid: (...args_1) => {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(bidderId_0).concat(_descriptor_0.toValue(amount_0).concat(_descriptor_2.toValue(salt_0))),
      ...
      settleAuction: (...args_1) => {
        ...
        if (!(callerId_0.buffer instanceof ArrayBuffer && callerId_0.BYTES_PER_ELEMENT === 1 && callerId_0.length === 32)) {
          __compactRuntime.typeError('settleAuction',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'bboard.compact line 81 char 1',
                                     'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(callerId_0),
        ...
        const result_0 = this._settleAuction_0(context,
                                               partialProofData,
                                               callerId_0);
        partialProofData.output = { value: [], alignment: [] };
        // Push to callProofDataTrace for new SDK (v0.19+) compatibility
      ...
      openReveal: (...args_1) => {
        ...
        const result_0 = this._openReveal_0(context,
                                            partialProofData,
                                            callerId_0);
        partialProofData.output = { value: [], alignment: [] };
        // Push to callProofDataTrace for new SDK (v0.19+) compatibility
  ...
  initialState(...args_0) {
    ...
    const lot_0 = args_0[2];
    const reserve_0 = args_0[3];
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(1n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(sellerId_0),
                                                                                              alignment: _descriptor_2.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(2n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(lot_0),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(3n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(reserve_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
  ...
  _commitBid_0(context, partialProofData, bidderId_0, amount_0, salt_0) {
    ...
    const commitment_0 = this._persistentHash_0([bidderId_0, amount_0, salt_0]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
  ...
  _revealBid_0(context, partialProofData, bidderId_0, amount_0, salt_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'no commitment on file for bidder');
    __compactRuntime.assert(!_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
    ...
    const recomputed_0 = this._persistentHash_0([bidderId_0, amount_0, salt_0]);
  ...
  _settleAuction_0(context, partialProofData, callerId_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            1,
                            'auction already settled or not yet opened');
    __compactRuntime.assert(this._equal_1(callerId_0,
                                          _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'only the seller can settle the lot');
    let t_0;
  ...
  _openReveal_0(context, partialProofData, callerId_0) {
    __compactRuntime.assert(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            0,
                            'auction is not in the commit phase');
    __compactRuntime.assert(this._equal_2(callerId_0,
                                          _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'only the seller can open the reveal phase');
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
